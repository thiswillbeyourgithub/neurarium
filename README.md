...
**83% of the 785 factual claims in the dataset are sourced or verified.** This is a programmatic count (`tools/update_readme_stats.py`, from the emitted data), not hand-typed:
