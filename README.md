...
**73% of the 785 factual claims in the dataset are sourced or verified.** This is a programmatic count (`tools/update_readme_stats.py`, from the emitted data), not hand-typed:

| Claim kind | Sourced or verified |
| --- | --- |
| Drug target bindings | 403 / 429 (94%) |
| Drug nomenclature (NbN) | 113 / 116 (97%) |
| Neuron pathways | 60 / 107 (56%) |
