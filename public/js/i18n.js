...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "drug.pkRaises": "Could raise {drug}",
      "drug.pkLowers": "Could lower {drug}",
      "drug.pkRaisedBy": "Could be raised by {drug}",
      "drug.pkLoweredBy": "Could be lowered by {drug}",
      "drug.pkMore": "+{n} more",
    ...
    fr: {
      ...
      "drug.pkRaises": "Pourrait augmenter {drug}",
      "drug.pkLowers": "Pourrait diminuer {drug}",
      "drug.pkRaisedBy": "Pourrait être augmenté par {drug}",
      "drug.pkLoweredBy": "Pourrait être diminué par {drug}",
