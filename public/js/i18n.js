...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "drug.pkInteractions": "Interactions",
      "drug.pkInteractionsHint": "Derived, not measured: this drug and the listed one meet at the same enzyme. A raise means the other drug's blood level goes up (this one inhibits the enzyme clearing it), a lower means it goes down (this one induces it). A flag worth checking with a prescriber, never a contraindication, and the absence of a row is not a safety claim.",
      "drug.pkRaises": "Raises {drug}",
      "drug.pkLowers": "Lowers {drug}",
      "drug.pkRaisedBy": "Raised by {drug}",
      "drug.pkLoweredBy": "Lowered by {drug}",
      "drug.pkMore": "+{n} more",
      "drug.pkByDrug": "By drug",
      "drug.pkByEnzyme": "By enzyme",
      "drug.pkHeadRaises": "Raises the level of",
      "drug.pkHeadLowers": "Lowers the level of",
      "drug.pkHeadRaisedBy": "Its level is raised by",
      "drug.pkHeadLoweredBy": "Its level is lowered by",
    ...
    fr: {
      ...
      "drug.pkInteractions": "Interactions",
      "drug.pkInteractionsHint": "Déduit, non mesuré : ce médicament et celui listé se rencontrent sur la même enzyme. « augmente » signifie que la concentration sanguine de l'autre monte (celui-ci inhibe l'enzyme qui l'élimine), « diminue » qu'elle baisse (il l'induit). Un signal à vérifier avec un prescripteur, jamais une contre-indication, et l'absence de ligne ne vaut pas garantie d'innocuité.",
      "drug.pkRaises": "Augmente {drug}",
      "drug.pkLowers": "Diminue {drug}",
      "drug.pkRaisedBy": "Augmenté par {drug}",
      "drug.pkLoweredBy": "Diminué par {drug}",
      "drug.pkMore": "+{n} de plus",
      "drug.pkByDrug": "Par médicament",
      "drug.pkByEnzyme": "Par enzyme",
      "drug.pkHeadRaises": "Augmente la concentration de",
      "drug.pkHeadLowers": "Diminue la concentration de",
      "drug.pkHeadRaisedBy": "Sa concentration est augmentée par",
      "drug.pkHeadLoweredBy": "Sa concentration est diminuée par",
