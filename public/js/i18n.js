...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "receptor.locUnsourced": "Which regions express this receptor is LLM-authored (general knowledge), not yet checked against an expression atlas.",
      ...
      "drug.projectionsAffectedHint": "Ascending pathways of the systems this drug acts on. Derived from its bindings; no increase or decrease is implied.",
    ...
    fr: {
      ...
      "receptor.locUnsourced": "La liste des régions exprimant ce récepteur est rédigée par IA (connaissances générales), pas encore vérifiée contre un atlas d'expression.",
      ...
      "drug.projectionsAffectedHint": "Voies ascendantes des systèmes sur lesquels ce médicament agit. Déduit de ses liaisons ; aucune hausse ni baisse n'est impliquée.",
