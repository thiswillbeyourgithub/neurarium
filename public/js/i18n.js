...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "sim.warn.dose": "No dose, bioavailability, protein binding or absorption data: every drug shares one assumed time-to-peak of {h} h, after a single dose.",
    ...
    fr: {
      ...
      "sim.warn.dose": "Aucune donnée de dose, de biodisponibilité, de liaison aux protéines ni d'absorption : tous les médicaments partagent un même délai de pic supposé de {h} h, après une prise unique.",
