...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "sim.warn.dose": "No dose, bioavailability, distribution volume, free fraction or brain penetration, so no concentration at a receptor can be worked out: every drug shares one assumed time-to-peak of {h} h after a single dose, and the bars stay an index rather than a percentage occupied.",
    ...
    fr: {
      ...
      "sim.warn.dose": "Ni dose, ni biodisponibilité, ni volume de distribution, ni fraction libre, ni pénétration cérébrale : aucune concentration au récepteur ne peut donc être calculée. Tous les médicaments partagent un même délai de pic supposé de {h} h après une prise unique, et les barres restent un indice plutôt qu'un pourcentage d'occupation.",
