...
``data_sources/books/stahl/INDEX.md``) and, per un-sourced binding, the target's human name, the
...
This is an *authoring* helper (it reads the author-side ``data_sources/books/stahl/INDEX.md``); it is
