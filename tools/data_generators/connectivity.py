...
PROJECTIONS: list[dict[str, Any]] = [
    ...
    dict(**{"from": "raphe", "to": "thalamus_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (thalamic)",
         description="Raphe serotonin projects to the thalamus, colouring the "
                     "sensory traffic it relays to the cortex."),
    dict(**{"from": "raphe", "to": "parietal_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (parietal)",
         description="Raphe serotonin fibers reach the parietal cortex."),
    dict(**{"from": "raphe", "to": "temporal_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (temporal)",
         description="Raphe serotonin fibers reach the temporal cortex."),
    dict(**{"from": "raphe", "to": "occipital_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (occipital)",
         description="Raphe serotonin fibers reach the occipital cortex."),
    dict(**{"from": "raphe", "to": "cingulate_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (cingulate)",
         description="Raphe serotonin innervates the cingulate cortex, part of "
                     "the mood circuitry an antidepressant acts on."),
    dict(**{"from": "raphe", "to": "accumbens_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (accumbens)",
         description="Dorsal raphe serotonin projects to the ventral striatum, "
                     "damping reward drive."),
    dict(**{"from": "raphe", "to": "caudate_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (caudate)",
         description="Dorsal raphe serotonin projects to the caudate nucleus."),
    dict(**{"from": "raphe", "to": "putamen_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (putamen)",
         description="Dorsal raphe serotonin projects to the putamen."),
    dict(**{"from": "raphe", "to": "substantia_nigra_R"},
         kind="serotonergic", neurotransmitter="Serotonin",
         label="Ascending serotonergic (nigral)",
         description="Median raphe serotonin reaches the substantia nigra, "
                     "restraining its dopamine neurons."),
    ...
    dict(**{"from": "locus_coeruleus_R", "to": "parietal_R"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (parietal)",
         description="Locus coeruleus noradrenaline reaches the parietal cortex."),
    dict(**{"from": "locus_coeruleus_R", "to": "temporal_R"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (temporal)",
         description="Locus coeruleus noradrenaline reaches the temporal cortex."),
    dict(**{"from": "locus_coeruleus_R", "to": "occipital_R"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (occipital)",
         description="Locus coeruleus noradrenaline reaches the occipital cortex."),
    dict(**{"from": "locus_coeruleus_R", "to": "cingulate_R"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (cingulate)",
         description="Locus coeruleus noradrenaline reaches the cingulate "
                     "cortex."),
    dict(**{"from": "locus_coeruleus_R", "to": "hypothalamus_R"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (hypothalamic)",
         description="Locus coeruleus noradrenaline projects to the "
                     "hypothalamus, coupling arousal to autonomic and endocrine "
                     "control."),
    dict(**{"from": "locus_coeruleus_R", "to": "cerebellum"},
         kind="noradrenergic", neurotransmitter="Noradrenaline",
         label="Ascending noradrenergic (cerebellar)",
         description="Locus coeruleus noradrenaline innervates the cerebellar "
                     "cortex, setting the gain of its circuitry."),
